 ...
 * 3. rendering mold (@see mold/ganttchart.js )
 ...
 *
 */
ganttchart.GanttChart = zk.$extends(zul.Widget, {
	...
	*/
	bind_: function () {
		 ...
		 */
		this.$supers(ganttchart.GanttChart,'bind_', arguments);
	...
	*/
	unbind_: function () {
		...
		*/
		this.$supers(ganttchart.GanttChart,'unbind_', arguments);
	},
	/*
